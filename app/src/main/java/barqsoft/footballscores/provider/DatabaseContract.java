...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        //Table data
        public static String LEAGUE_COL = "league";
        public static String DATE_COL = "date";
        public static String TIME_COL = "time";
        public static String HOME_COL = "home";
        public static String AWAY_COL = "away";
        public static String HOME_GOALS_COL = "home_goals";
        public static String AWAY_GOALS_COL = "away_goals";
